  ...
  return (
    <div className="space-y-6 select-none">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1 p-1 rounded-lg bg-[#111827] border border-slate-800 text-xs font-mono overflow-x-auto">
      ...
      {/* Main Grid: Events Feed (7 cols) + Detail Inspection (5 cols) */}
                    ...
                    {filteredEvents.map((evt, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-3">
                            <span className="text-slate-300 block">{evt.user_id || 'System'}</span>
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <strong className="text-slate-200">{selectedEvent.event_type}</strong>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <strong className="text-slate-200">{selectedEvent.tenant_id}</strong>
                  </div>
                  {selectedEvent.user_id && (
                    <div className="flex justify-between">
                      <span className="text-slate-400">User / Agent:</span>
                      <strong className="text-slate-200">{selectedEvent.user_id}</strong>
                    </div>
                  )}
                  {selectedEvent.request_id && (
                    <div className="flex justify-between">
                      <span className="text-slate-400">Request ID:</span>
                      <strong className="text-slate-200 select-all">
                        {selectedEvent.request_id}
                      </strong>
                    </div>
                  )}
