...
export const DashboardView: React.FC = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 select-none max-w-full">
      ...
      {/* Error State */}
      {summaryError && (
        <div className="p-3.5 sm:p-4 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            <AlertTriangle className="w-5 h-5 text-rose-400 shrink-0" />
            <span className="text-xs font-mono break-words">
              Unable to reach SecureOps telemetry service. Verifying gateway connection...
            </span>
          </div>
          <button
            onClick={() => refetchSummary()}
            className="px-3 py-1.5 min-h-[44px] sm:min-h-0 rounded bg-rose-500/20 hover:bg-rose-500/30 text-xs font-mono text-rose-200 border border-rose-500/30 self-end sm:self-auto cursor-pointer"
          >
            Retry
          </button>
        </div>
      ...
      {/* Primary 4 Metric Cards (1-col mobile, 2-col tablet, 4-col desktop) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {/* Card 1: Requests Today */}
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 hover:border-slate-700/80 transition-colors flex flex-col justify-between">
          ...
          <div>
            ...
            <div className="mt-1.5 sm:mt-2 text-[11px] text-slate-500 font-mono flex items-center gap-1.5">
              <Activity className="w-3.5 h-3.5 text-cyan-400 shrink-0" />
              <span className="truncate">Monitored via Gateway</span>
            </div>
          </div>
        </div>

        {/* Card 2: Allowed Requests */}
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 hover:border-emerald-500/30 transition-colors flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2 sm:mb-3">
          ...
          <div>
            ...
            <div className="mt-1.5 sm:mt-2 text-[11px] text-slate-500 font-mono flex items-center gap-1.5">
              ...
              <span className="truncate">Passed Security Policy</span>
            </div>
          </div>
        </div>

        {/* Card 3: Blocked Requests */}
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 hover:border-rose-500/30 transition-colors flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2 sm:mb-3">
          ...
          <div>
            ...
            <div className="mt-1.5 sm:mt-2 text-[11px] text-slate-500 font-mono flex items-center gap-1.5">
              ...
              <span className="truncate">Policy Engine Enforced</span>
            </div>
          </div>
        </div>

        {/* Card 4: Pending Approvals */}
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 hover:border-amber-500/30 transition-colors flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2 sm:mb-3">
          ...
          <div>
            ...
            <div className="mt-1.5 sm:mt-2 text-[11px] text-slate-500 font-mono flex items-center gap-1.5">
              ...
              <span className="truncate">Awaiting Security Officer</span>
            </div>
          </div>
        </div>
      </div>

      {/* Secondary Security Overview (2-col mobile, 4-col tablet/desktop) */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
        {/* Security Events */}
        <div className="p-3.5 sm:p-4 rounded-xl bg-[#0e1422] border border-slate-800/80 min-w-0">
          <div className="flex items-center gap-1.5 text-slate-400 text-xs font-mono mb-1 truncate">
            <ShieldAlert className="w-3.5 h-3.5 text-rose-400 shrink-0" />
            <span className="truncate">Security Events</span>
          </div>
        ...
        <div className="p-3.5 sm:p-4 rounded-xl bg-[#0e1422] border border-slate-800/80 min-w-0">
          <div className="flex items-center gap-1.5 text-slate-400 text-xs font-mono mb-1 truncate">
            ...
            <span className="truncate">Fallbacks</span>
          </div>
          <div className="text-base sm:text-lg font-bold text-white font-mono truncate">
      ...
      {/* Main Two-Column Telemetry Section (1-col mobile/tablet, 2-col desktop) */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        {/* Left Column: Security Decision Distribution */}
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-mono flex-wrap gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 pt-1 sm:pt-2">
            <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800">
              ...
              <div className="text-lg sm:text-xl font-bold text-emerald-400 font-mono mt-0.5 sm:mt-1">
                {allowCount}
              </div>
              <div className="text-[10px] text-slate-500 font-mono mt-0.5 sm:mt-1">
            ...
            <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800">
              ...
              <div className="text-lg sm:text-xl font-bold text-rose-400 font-mono mt-0.5 sm:mt-1">
                {blockCount}
              </div>
              <div className="text-[10px] text-slate-500 font-mono mt-0.5 sm:mt-1">
        ...
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2 sm:space-y-2.5">
            ...
            <div className="p-2.5 sm:p-3 rounded-lg bg-[#0e1422] border border-slate-800 flex items-center justify-between gap-2">
              <div className="flex items-center gap-2.5 min-w-0">
                <Activity className="w-4 h-4 text-cyan-400 shrink-0" />
                <div className="min-w-0">
                  <div className="text-xs font-semibold text-slate-200 truncate">Rate Limiter</div>
                  <div className="text-[10px] text-slate-400 font-mono truncate">In-Memory / Redis Backend</div>
                </div>
              </div>
              <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-mono uppercase shrink-0">
            ...
            <div className="p-2.5 sm:p-3 rounded-lg bg-[#0e1422] border border-slate-800 flex items-center justify-between gap-2">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="text-xs font-semibold text-slate-200 truncate">PostgreSQL Data Store</div>
                  <div className="text-[10px] text-slate-400 font-mono truncate">Partitioned Audits & Credentials</div>
                </div>
              </div>
              <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-mono uppercase shrink-0">
            ...
            <div className="p-2.5 sm:p-3 rounded-lg bg-[#0e1422] border border-slate-800 flex items-center justify-between gap-2">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="text-xs font-semibold text-slate-200 truncate">AI Gateway Core Engine</div>
                  <div className="text-[10px] text-slate-400 font-mono truncate">Policy Enforcement & Telemetry</div>
                </div>
              </div>
              <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-mono uppercase shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-3">
          <div className="flex items-center gap-2 border-b border-slate-800 pb-2.5 sm:pb-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
            <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800">
              ...
              <strong className="text-sm sm:text-base font-mono text-slate-200 mt-1 block">
        ...
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
            <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800">
              ...
              <strong className="text-sm sm:text-base font-mono text-rose-400 mt-1 block">
                {summary?.metrics?.execution_failure_count ?? 0}
              </strong>
            </div>
            <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800">
              <span className="text-[10px] text-slate-500 font-mono block">Rate Throttles</span>
              <strong className="text-sm sm:text-base font-mono text-amber-400 mt-1 block">
