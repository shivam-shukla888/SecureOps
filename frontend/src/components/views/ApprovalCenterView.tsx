  ...
  return (
    <div className="space-y-6 select-none">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        {/* Status Filter Pills */}
        <div className="flex items-center gap-1.5 p-1 rounded-lg bg-[#111827] border border-slate-800 text-xs font-mono">
      ...
      {/* Main Grid: Queue on Left (7 cols), Detail on Right (5 cols) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Left Column: Approval Queue Table */}
                  ...
                  <tbody className="divide-y divide-slate-800/60 font-mono text-xs">
                    {filteredTickets.map((t) => {
                      ...
                      return (
                        ...
                        >
                          <td className="p-3">
                            <span className="text-cyan-400 font-bold block">{t.approval_id}</span>
                            <span className="text-[10px] text-slate-500">{t.request_id}</span>
                          </td>
                          <td className="p-3 text-slate-300">{t.requester_id}</td>
                          <td className="p-3">
                            <span className="text-slate-200 block">{t.intent}</span>
              ...
              <div className="space-y-2 font-mono text-xs">
                ...
                <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2">
                  <div className="flex justify-between">
                    ...
                    <strong className="text-slate-200 select-all">{selectedTicket.request_id}</strong>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <strong className="text-slate-200">{selectedTicket.intent}</strong>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2">
                  ...
                  {selectedTicket.approver_id && (
                    <div className="flex justify-between pt-1 border-t border-slate-800">
                      ...
                      <strong className="text-cyan-400">{selectedTicket.approver_id}</strong>
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="pt-3 border-t border-slate-800 space-y-3 font-mono text-xs">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0a0f1b] border border-slate-800 focus:border-cyan-500 rounded-lg px-3 py-2 text-xs text-slate-200 focus:outline-none disabled:opacity-50"
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-semibold flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50 cursor-pointer"
                    >
                      {approveMutation.isPending ? (
                    ...
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-lg bg-rose-600 hover:bg-rose-500 text-white font-semibold flex items-center justify-center gap-1.5 transition-colors disabled:opacity-50 cursor-pointer"
                    >
                      {rejectMutation.isPending ? (
                        <RefreshCw className="w-4 h-4 animate-spin" />
                      ) : (
