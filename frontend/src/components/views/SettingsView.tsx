        ...
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-4">
          ...
          <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2.5">
            <div className="flex justify-between items-center gap-2">
              ...
              <strong className="text-slate-200 select-all text-right break-all">{userId || 'admin_operator'}</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <strong className="text-cyan-400 select-all text-right break-all">{tenantId}</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">Session Vault Mode:</span>
              <span className="text-emerald-400 font-bold text-right shrink-0">SHA-256 Hashed Key</span>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-4">
          ...
          <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2.5">
            <div className="space-y-1">
              ...
              <div className="p-2 rounded bg-[#0a0f1b] border border-rose-500/30 text-rose-300 text-[11px] font-mono select-all break-all overflow-x-auto">
            ...
            <div className="space-y-1 pt-1">
              ...
              <div className="p-2 rounded bg-[#0a0f1b] border border-emerald-500/30 text-emerald-300 text-[11px] font-mono select-all break-all overflow-x-auto">
        ...
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-4">
          ...
          <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2.5">
            <div className="flex justify-between items-center gap-2">
              ...
              <strong className="text-slate-200 text-right">10.0 seconds</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">HITL Ticket Expiry:</span>
              <strong className="text-slate-200 text-right">60 minutes (Time-Bound)</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">Max Request Payload Size:</span>
              <strong className="text-slate-200 text-right">1,048,576 bytes (1 MB)</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">Max Request Prompt Length:</span>
              <strong className="text-slate-200 text-right">4,000 characters</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">Idempotency Key TTL:</span>
              <strong className="text-slate-200 text-right">86,400 seconds (24h)</strong>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-5 rounded-xl bg-[#111827] border border-slate-800/80 space-y-4">
          ...
          <div className="p-3 rounded-lg bg-[#0e1422] border border-slate-800 space-y-2.5">
            <div className="flex justify-between items-center gap-2">
              ...
              <strong className="text-cyan-300 text-right">gpt-4o-mini</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">Fallback Tier 1:</span>
              <strong className="text-purple-300 text-right">gemini-3.5-flash</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">Fallback Tier 2:</span>
              <strong className="text-amber-300 text-right">openai/gpt-oss-20b</strong>
            </div>
            <div className="flex justify-between items-center gap-2">
              <span className="text-slate-400">Deterministic Safety Fallback:</span>
              <span className="text-emerald-400 font-bold text-right shrink-0">Regex Pattern Engine</span>
            </div>
          </div>
        </div>
      </div>
